...
pub use learned::{
    ...
    BinaryCalibrationReportV1, BinaryPredictionV1, CONTEXT_PROJECTION_HASH_DOMAIN,
    CalibrationBinV1, CalibrationDataSplitV1, CapabilityEffectV1, CapabilityKindV1,
    ChatCompletionEnvelopeV1, ConfusionMatrixV1, ContextFieldMetadataV1, ContextFieldProvenanceV1,
    ContextFieldV1, ContextProjectionClassV1, ContextProjectionV1, ContextReviewStateV1,
    ContextSensitivityV1, ContractError, EVALUATOR_RELEASE_SCHEMA_VERSION, EvaluationCriterionV1,
    ...
    EvaluationInputBoundsV1, EvaluationTargetKind, EvaluatorReleaseSpecV1, HumanAgreementReportV1,
    IdempotencyClassV1, LEARNED_EVALUATION_SCHEMA_VERSION, LearnedAbstentionReasonV1,
    ...
    ProviderTokenUsageV1, SelectiveRiskPointV1, SuccessCriterionImportanceV1, SuccessCriterionV1,
...
pub mod prelude {
    ...
    pub use crate::learned::{
        ...
        BinaryPredictionV1, CONTEXT_PROJECTION_HASH_DOMAIN, CalibrationBinV1,
        CalibrationDataSplitV1, CapabilityEffectV1, CapabilityKindV1, ChatCompletionEnvelopeV1,
        ConfusionMatrixV1, ContextFieldMetadataV1, ContextFieldProvenanceV1, ContextFieldV1,
        ...
        EvaluationTargetKind, EvaluatorReleaseSpecV1, HumanAgreementReportV1, IdempotencyClassV1,
        LearnedAbstentionReasonV1, LearnedCalibrationFeaturesV1, LearnedEvaluationV1,
        LearnedTaskKind, LearnedVerdictV1, ProviderExecutionFailureV1, ProviderExecutionStageV1,
        ProviderResponseEnvelopeV1, ProviderTokenUsageV1, SelectiveRiskPointV1,
        SuccessCriterionImportanceV1, SuccessCriterionV1, TASK_COMPLETION_JUDGMENT_SCHEMA_VERSION,
        TASK_COMPLETION_PROJECTION_SCHEMA_VERSION, TASK_COMPLETION_PROJECTOR_VERSION,
