...
pub use learned::{
    ...
    TaskCompletionEvaluator, TaskCompletionEvidenceLaneV1, TaskCompletionExecutionV1,
    TaskCompletionGoalBundleV1, TaskCompletionInferenceProvenanceV1, TaskCompletionJudgmentV1,
    TaskCompletionOutcomeV1, TaskCompletionProjectionV1, TaskCompletionProjectorV1,
    TaskCompletionRecoveryChainV1, TaskCompletionToolObservationV1, TaskCompletionTraceFactV1,
...
pub mod prelude {
    ...
    pub use crate::learned::{
        ...
        TaskCompletionEvidenceLaneV1, TaskCompletionExecutionV1, TaskCompletionGoalBundleV1,
        TaskCompletionInferenceProvenanceV1, TaskCompletionJudgmentV1, TaskCompletionOutcomeV1,
        TaskCompletionProjectionV1, TaskCompletionProjectorV1, TaskCompletionRecoveryChainV1,
        TaskCompletionToolObservationV1, TaskCompletionTraceFactV1,
        TaskCompletionTraceObservationV1, TaxonomyAssignmentSourceV1, TaxonomyAssignmentV1,
        TaxonomyDimensionV1, TaxonomyLineageOperationV1, TaxonomyNodeStateV1, TaxonomyNodeV1,
        TaxonomyOpenSetStateV1, TaxonomyRelationKindV1, TaxonomyRelationV1,
        TraceContextBindingProvenanceV1, TraceContextBindingResolutionV1, TraceContextBindingV1,
