...
pub use learned::{
    ...
    BinaryPredictionV1, CONTEXT_PROJECTION_HASH_DOMAIN, CalibrationBinV1, CalibrationDataSplitV1,
    CapabilityEffectV1, CapabilityKindV1, ChatCompletionEnvelopeV1, ConfusionMatrixV1,
    ContextFieldMetadataV1, ContextFieldProvenanceV1, ContextFieldV1, ContextProjectionClassV1,
    ContextProjectionV1, ContextReviewStateV1, ContextSensitivityV1, ContractError,
    ...
    TASK_COMPLETION_PROJECTOR_VERSION, TRACE_CONTEXT_BINDING_SCHEMA_VERSION,
...
pub mod prelude {
    ...
    pub use crate::learned::{
        ...
        AgentPolicyContextV1, AgentTaxonomyReleaseV1, BINARY_CALIBRATION_MODEL_SCHEMA_VERSION,
        ...
        EvaluationInputBoundsV1, EvaluationTargetKind, EvaluatorReleaseSpecV1, IdempotencyClassV1,
