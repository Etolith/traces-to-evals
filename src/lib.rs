...
pub use learned::{
    ...
    BINARY_TASK_COMPLETION_DECISION_SCHEMA_VERSION, BinaryCalibrationExampleV1,
    BinaryCalibrationFitOptionsV1, BinaryCalibrationModelV1, BinaryCalibrationReportV1,
    BinaryPredictionV1, BinaryTaskCompletionDecisionV1, BinaryTaskCompletionOutcomeV1,
    BinomialRateIntervalV1, COMPACT_TASK_COMPLETION_PROJECTION_SCHEMA_VERSION,
    CONTEXT_PROJECTION_HASH_DOMAIN, CalibrationBinV1, CalibrationDataSplitV1, CapabilityEffectV1,
    CapabilityKindV1, ChatCompletionEnvelopeV1, CompactTaskCompletionProjectionStatsV1,
    CompactTaskCompletionProjectionV1, CompactTaskCompletionTokenBudgetV1,
    CompactTaskCompletionVariantV1, ConfusionMatrixV1, ContextFieldMetadataV1,
    ...
    TASK_COMPLETION_STRUCTURED_FEATURE_NAMES, TASK_COMPLETION_STRUCTURED_FEATURE_SET_VERSION,
    TASK_COMPLETION_TRAINING_RECORD_SCHEMA_VERSION, TRACE_CONTEXT_BINDING_SCHEMA_VERSION,
    ...
    TaskCompletionEvaluator, TaskCompletionEvidenceFeatureRecordV1, TaskCompletionEvidenceLaneV1,
    TaskCompletionExecutionV1, TaskCompletionGoalBundleV1, TaskCompletionInferenceProvenanceV1,
    TaskCompletionJudgmentV1, TaskCompletionOutcomeV1, TaskCompletionProjectionV1,
    TaskCompletionProjectorV1, TaskCompletionRecoveryChainV1,
    TaskCompletionStructuredEvidenceFeaturesV2, TaskCompletionToolObservationV1,
    TaskCompletionTraceFactV1, TaskCompletionTraceObservationV1, TaskCompletionTrainingRecordV1,
    ...
    TraceContextBindingResolutionV1, TraceContextBindingV1, TraceFactActorV1, TraceFactKindV1,
    TraceFactStatusV1, canonical_content_id, canonical_json_bytes,
...
pub mod prelude {
    ...
    pub use crate::learned::{
        ...
        BINARY_CALIBRATION_MODEL_SCHEMA_VERSION, BINARY_TASK_COMPLETION_DECISION_SCHEMA_VERSION,
        BinaryCalibrationExampleV1, BinaryCalibrationFitOptionsV1, BinaryCalibrationModelV1,
        BinaryCalibrationReportV1, BinaryPredictionV1, BinaryTaskCompletionDecisionV1,
        BinaryTaskCompletionOutcomeV1, BinomialRateIntervalV1,
        COMPACT_TASK_COMPLETION_PROJECTION_SCHEMA_VERSION, CONTEXT_PROJECTION_HASH_DOMAIN,
        CalibrationBinV1, CalibrationDataSplitV1, CapabilityEffectV1, CapabilityKindV1,
        ChatCompletionEnvelopeV1, CompactTaskCompletionProjectionStatsV1,
        CompactTaskCompletionProjectionV1, CompactTaskCompletionTokenBudgetV1,
        CompactTaskCompletionVariantV1, ConfusionMatrixV1, ContextFieldMetadataV1,
        ContextFieldProvenanceV1, ContextFieldV1, ContextProjectionClassV1, ContextProjectionV1,
        ...
        SuccessCriterionV1, TASK_COMPLETION_EVIDENCE_FEATURE_RECORD_SCHEMA_VERSION,
        TASK_COMPLETION_JUDGMENT_SCHEMA_VERSION, TASK_COMPLETION_PROJECTION_SCHEMA_VERSION,
        TASK_COMPLETION_PROJECTOR_VERSION, TASK_COMPLETION_STRUCTURED_FEATURE_NAMES,
        TASK_COMPLETION_STRUCTURED_FEATURE_SET_VERSION,
        TASK_COMPLETION_TRAINING_RECORD_SCHEMA_VERSION, TaskCompletionCapabilityV1,
        TaskCompletionContentPolicyV1, TaskCompletionCriterionJudgmentV1,
        TaskCompletionCriterionOutcomeV1, TaskCompletionCriterionSpecV1,
        TaskCompletionDeclaredFieldV1, TaskCompletionEvaluator,
        TaskCompletionEvidenceFeatureRecordV1, TaskCompletionEvidenceLaneV1,
        TaskCompletionExecutionV1, TaskCompletionGoalBundleV1, TaskCompletionInferenceProvenanceV1,
        TaskCompletionJudgmentV1, TaskCompletionOutcomeV1, TaskCompletionProjectionV1,
        TaskCompletionProjectorV1, TaskCompletionRecoveryChainV1,
        TaskCompletionStructuredEvidenceFeaturesV2, TaskCompletionToolObservationV1,
        TaskCompletionTraceFactV1, TaskCompletionTraceObservationV1,
        TaskCompletionTrainingRecordV1, TaxonomyAssignmentSourceV1, TaxonomyAssignmentV1,
        ...
        canonical_json_bytes, task_completion_judgment_response_schema,
    };
    pub use crate::model::{
