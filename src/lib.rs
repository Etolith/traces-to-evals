...
pub use behavior::{
    ...
    BEHAVIOR_ADAPTER_SCHEMA_VERSION, BEHAVIOR_FINDING_SCHEMA_VERSION, BehaviorAdapterConfig,
    BehaviorFinding, BehaviorFindingSink, BudgetRegressionGate, CandidateGenerator,
    CandidateReview, CandidateReviewDecision, ClaimedOutcomeStatus,
    DEFAULT_FINDING_PROJECTION_VERSION, DEFAULT_SEMANTIC_BEHAVIOR_RUBRIC,
    DEFAULT_SEMANTIC_BEHAVIOR_RUBRIC_VERSION, DETECTION_CHECKPOINT_SCHEMA_VERSION,
    DETERMINISTIC_DETECTOR_VERSION, DetectionCheckpoint, DetectionRunStats, DetectionRunner,
    ...
    FalseSuccessClaimDetector, FinalOutcome, FinalOutcomeStatus, FindingEvalCandidateGenerator,
    FindingKindRate, FindingProjection, FindingRecurrenceComparator, FindingRecurrenceComparison,
    FindingRecurrenceRequest, FindingRedactor, FindingSeverity, FindingWindow, FindingWriteStatus,
    IncidentRegressionGate, KNOWN_SIGNATURE_GROUP_SCHEMA_VERSION, KnownSignatureGroup,
    KnownSignatureGrouper, MissingResolutionDetector, NormalizedToolError,
    OpenInferenceBehaviorNormalizer, OperationEffect, OutcomeClaim,
    ...
    PairedFindingVerifier, PolicyDecision, PolicyDecisionOutcome, PolicyViolationDetector,
    PopulationBasis, REMEDIATION_VERIFICATION_REQUEST_SCHEMA_VERSION,
    REMEDIATION_VERIFICATION_SCHEMA_VERSION, REMEDIATION_VERIFIER_VERSION, RecoveryAnalyzer,
    RecoveryStatus, RedactedCandidateInput, RemediationInputArtifacts,
    RemediationVerificationPolicy, RemediationVerificationReport, RemediationVerificationRequest,
    RemediationVerifier, RepeatedToolFailureDetector, RetrySafety, SEMANTIC_BEHAVIOR_DETECTOR_ID,
    ...
    TerminalToolFailureDetector, ToolCallFact, ToolCallLoopDetector, ToolCallStatus,
    ToolRequirement, ToolSemanticMapping, TraceDetector, TraceEnvelope,
...
pub mod prelude {
    pub use crate::behavior::{
        ...
        DETERMINISTIC_DETECTOR_VERSION, DetectionCheckpoint, DetectionRunStats, DetectionRunner,
        DeterministicDetectorSet, EVAL_CANDIDATE_SCHEMA_VERSION, EVIDENCE_PACKET_SCHEMA_VERSION,
        EscalationStatus, EvalCandidate, EvalCandidateGenerator, EvalCandidateStatus,
        EvidencePacket, EvidencePacketBuilder, EvidenceRef, ExcessiveToolUsageDetector,
        ExecutionBudget, FINDING_PROJECTION_SCHEMA_VERSION, FINDING_RECURRENCE_COMPARATOR_VERSION,
        FINDING_RECURRENCE_COMPARISON_SCHEMA_VERSION, FINDING_RECURRENCE_REQUEST_SCHEMA_VERSION,
        FalseSuccessClaimDetector, FinalOutcome, FinalOutcomeStatus, FindingEvalCandidateGenerator,
        FindingKindRate, FindingProjection, FindingRecurrenceComparator,
        ...
        PolicyViolationDetector, PopulationBasis, REMEDIATION_VERIFICATION_REQUEST_SCHEMA_VERSION,
        REMEDIATION_VERIFICATION_SCHEMA_VERSION, REMEDIATION_VERIFIER_VERSION, RecoveryAnalyzer,
        RecoveryStatus, RedactedCandidateInput, RemediationInputArtifacts,
        RemediationVerificationPolicy, RemediationVerificationReport,
        RemediationVerificationRequest, RemediationVerifier, RepeatedToolFailureDetector,
        RetrySafety, SEMANTIC_BEHAVIOR_DETECTOR_ID, SEMANTIC_BEHAVIOR_DETECTOR_VERSION,
        SEMANTIC_BEHAVIOR_EVALUATION_SCHEMA_VERSION, SEMANTIC_BEHAVIOR_PROJECTION_SCHEMA_VERSION,
        SEMANTIC_BEHAVIOR_PROJECTION_VERSION, SafeFindingProjector, ScalarFindingRedactor,
        SemanticBehaviorDetectionRun, SemanticBehaviorDetector, SemanticBehaviorEvaluation,
        SemanticBehaviorEvaluator, SemanticBehaviorFinalOutcome, SemanticBehaviorJudgment,
        SemanticBehaviorPolicy, SemanticBehaviorProjection, SemanticBehaviorProjector,
        SemanticContentPolicy, SemanticEvidenceRef, SemanticFinalClaim, SemanticPolicyDecision,
        SemanticToolCall, SemanticVerdict, StateChangeRef, StateObservation, SuiteRegressionGate,
        TerminalToolFailureDetector, ToolCallFact, ToolCallLoopDetector, ToolCallStatus,
        ToolRequirement, ToolSemanticMapping, TraceDetector, TraceEnvelope,
        UncertainMutationStateDetector, UnresolvedEscalationDetector, VerificationArtifactDigest,
        VerificationGate, VerificationGateStatus, finding_projection_cases,
